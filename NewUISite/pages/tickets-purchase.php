...
<body>
    <div style="background: #141414; padding: 12px 20px; border-bottom: 2px solid #e50914; display: flex; justify-content: space-between; align-items: center;">
        ...
        <a href="selectTheater.php" style="color: #e50914; text-decoration: none; font-weight: bold; font-size: 0.8rem;">CHANGE THEATER</a>
    </div>

    <nav class="navbar">
        <div class="container d-flex justify-content-center gap-3">
            <a href="../index.php">Home</a>
            <a href="allMovies.php">Movies</a>
            <a href="getTickets.php" class="active">Tickets</a>
